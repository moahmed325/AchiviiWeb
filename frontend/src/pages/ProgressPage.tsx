    ...
    return (
      <div className="w-full flex-1 flex flex-col bg-[#0c1210] text-white min-h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-xs font-mono text-neutral-400">Aggregating 3-month goal metrics...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="w-full flex-1 flex flex-col bg-[#0c1210] text-white min-h-screen">
        ...
        <div className="flex-1 max-w-xl mx-auto px-4 py-16 text-center space-y-4">
          ...
          <p className="text-xs font-mono text-neutral-400">{error || 'No active goal found. Complete onboarding first.'}</p>
  ...
  const getPaceBadge = () => {
    switch (goal.paceStatus) {
      case 'GUARDRAIL_ALERT':
        return (
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-rose-500/10 text-rose-400 border border-rose-500/30 text-xs font-mono">
      ...
      case 'BEHIND_PACE':
        return (
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500/10 text-amber-400 border border-amber-500/30 text-xs font-mono">
      ...
      default:
        return (
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#07CB6C]/10 text-[#07CB6C] border border-[#07CB6C]/30 text-xs font-mono">
  ...
  return (
    <div className="w-full flex-1 flex flex-col bg-[#0c1210] text-white relative min-h-screen">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10 space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-[#1a2824]">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono font-medium uppercase tracking-wider text-[#07CB6C] px-2 py-0.5 rounded-md bg-[#07CB6C]/10 border border-[#07CB6C]/20">
                {goal.category}
              </span>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 shrink-0">
            ...
            <Link
              to="/schedule"
              className="min-h-[44px] px-4 py-2 rounded-lg bg-[#07CB6C] hover:bg-[#06b860] text-[#080d0b] text-xs font-mono font-medium flex items-center gap-1.5 transition-all active:scale-[0.99]"
            >
        ...
        <div className="bg-[#0a0f0d] p-5 sm:p-6 rounded-2xl border border-[#1a2824] space-y-3 shadow-2xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono pt-1">
            <div className="p-3.5 rounded-xl bg-[#0d1412] border border-[#1a2824]">
            ...
            <div className="p-3.5 rounded-xl bg-[#0d1412] border border-[#1a2824]">
              ...
              <span className="text-sm font-semibold text-amber-400 block mt-1 truncate">
            ...
            <div className="p-3.5 rounded-xl bg-[#0d1412] border border-[#1a2824]">
              ...
              <span className="text-sm font-semibold text-[#07CB6C] block mt-1 truncate">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-[#0a0f0d] p-5 rounded-2xl border border-[#1a2824] space-y-3 relative overflow-hidden shadow-2xl">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-medium uppercase tracking-wider text-neutral-400">Total Completion</span>
              <span className="p-1.5 rounded-lg bg-[#07CB6C]/10 text-[#07CB6C] border border-[#07CB6C]/20">
                <TrendingUp className="w-4 h-4" />
              </span>
            </div>
            <div>
              <div className="text-3xl font-bold text-white font-mono">{metrics.completionPercentage}%</div>
          ...
          <div className="bg-[#0a0f0d] p-5 rounded-2xl border border-[#1a2824] space-y-3 shadow-2xl">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-medium uppercase tracking-wider text-neutral-400">Hours Invested</span>
              <span className="p-1.5 rounded-lg bg-[#0d1412] text-[#07CB6C] border border-[#1a2824]">
                <Clock className="w-4 h-4" />
              </span>
            </div>
            <div>
              <div className="text-3xl font-bold text-white font-mono">{metrics.completedHours} hrs</div>
              <div className="text-xs font-mono text-neutral-400 mt-0.5">
          ...
          <div className="bg-[#0a0f0d] p-5 rounded-2xl border border-[#1a2824] space-y-3 shadow-2xl">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-medium uppercase tracking-wider text-neutral-400">Timeline Pacing</span>
              <span className="p-1.5 rounded-lg bg-[#0d1412] text-[#07CB6C] border border-[#1a2824]">
                <Calendar className="w-4 h-4" />
              </span>
            </div>
            <div>
              <div className="text-3xl font-bold text-white font-mono">{goal.daysRemaining} days</div>
              <div className="text-xs font-mono text-neutral-400 mt-0.5">
          ...
          <div className="bg-[#0a0f0d] p-5 rounded-2xl border border-[#1a2824] space-y-3 shadow-2xl">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-medium uppercase tracking-wider text-neutral-400">Current Phase</span>
        ...
        <div className="bg-[#0a0f0d] p-6 sm:p-7 rounded-2xl border border-[#1a2824] space-y-4 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
            {/* Original Target */}
            <div className="p-4 rounded-xl bg-[#0d1412] border border-[#1a2824] space-y-1.5 font-mono">
              <span className="text-[10px] font-medium uppercase tracking-wider text-neutral-400">Original Target Date</span>
            ...
            <div className={`p-4 rounded-xl border space-y-1.5 font-mono ${
              goal.slippageDays > 0 
                ...
                : 'bg-[#07CB6C]/10 border-[#07CB6C]/30 text-emerald-100'
            }`}>
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-medium uppercase tracking-wider">Projected Finish Date</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {phaseBreakdown.map((phase) => {
              ...
              return (
                <div
                  key={phase.id}
                  className={`bg-[#0a0f0d] p-5 rounded-2xl border flex flex-col justify-between space-y-4 shadow-2xl ${
                    isCompleted
                      ? 'border-[#07CB6C]/40 bg-[#07CB6C]/5'
                      : isInProgress
                      ? 'border-[#07CB6C]/50'
                      : 'border-[#1a2824]'
                  }`}
                >
                  <div className="space-y-3">
                      ...
                      <span
                        className={`text-[9px] font-medium px-2 py-0.5 rounded uppercase tracking-wider ${
                          isCompleted
                            ...
                            : 'bg-[#131f1b] text-neutral-400 border border-[#1a2824]'
                        }`}
                      >
                    ...
                    <div className="space-y-1.5 pt-1 font-mono">
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="font-semibold text-white">{phase.completionPercentage}%</span>
                      </div>
                      <div className="w-full h-1.5 rounded-full bg-[#131f1b] overflow-hidden">
                        <div
                    ...
                    {/* Task Templates list */}
                    <div className="pt-2 border-t border-[#1a2824] space-y-1.5 font-mono">
                      <span className="text-[10px] font-medium uppercase tracking-wider text-neutral-400">
                        Task Blueprints
                      </span>
                      <div className="space-y-1">
                        {phase.taskTemplates.map((template) => (
                          <div
                            key={template.id}
                            className="p-2.5 rounded-lg bg-[#0d1412] border border-[#1a2824] text-xs flex items-center justify-between gap-2"
                          >
                  ...
                  <Link
                    to={`/schedule`}
                    className="w-full min-h-[44px] py-2.5 rounded-lg bg-[#0d1412] hover:bg-[#131f1b] text-neutral-300 hover:text-white border border-[#1a2824] text-xs font-mono font-medium text-center transition-colors flex items-center justify-center cursor-pointer"
                  >
                    Inspect in Calendar →
                  </Link>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-[#0a0f0d] p-5 rounded-2xl border border-[#1a2824] space-y-4 lg:col-span-1 shadow-2xl">
            <h3 className="text-sm font-semibold text-white font-mono">Session Status Distribution</h3>
            <div className="space-y-3 font-mono">
              <div className="w-full h-2.5 rounded-full bg-[#131f1b] overflow-hidden flex">
                <div
                  title={`Done: ${metrics.completedSessions}`}
                  style={{ width: `${(metrics.completedSessions / (metrics.totalSessions || 1)) * 100}%` }}
                  className="bg-[#07CB6C] h-full"
                />
                <div
                  title={`Rescheduled: ${metrics.rescheduledSessions}`}
                  style={{ width: `${(metrics.rescheduledSessions / (metrics.totalSessions || 1)) * 100}%` }}
                  className="bg-amber-400 h-full"
                />
                <div
                  title={`Missed: ${metrics.missedSessions}`}
                  style={{ width: `${(metrics.missedSessions / (metrics.totalSessions || 1)) * 100}%` }}
                  className="bg-rose-500 h-full"
                />
                <div
                  title={`Upcoming: ${metrics.upcomingSessions}`}
                  style={{ width: `${(metrics.upcomingSessions / (metrics.totalSessions || 1)) * 100}%` }}
                  className="bg-[#1a2824] h-full"
                />
              </div>
              ...
              <div className="space-y-2 text-xs pt-1">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#07CB6C]" />
                    <span className="text-neutral-300">Completed Sessions</span>
                  </div>
                  <span className="font-semibold text-white">{metrics.completedSessions}</span>
                </div>

                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-amber-400" />
                    <span className="text-neutral-300">Buffer Shifts</span>
                  </div>
                  <span className="font-semibold text-amber-400">{metrics.rescheduledSessions}</span>
                </div>

                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-rose-500" />
                    <span className="text-neutral-300">Missed Sessions</span>
                  </div>
                  <span className="font-semibold text-rose-400">{metrics.missedSessions}</span>
                </div>

                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#1a2824]" />
                    <span className="text-neutral-300">Pending Execution</span>
                  </div>
                  <span className="font-semibold text-neutral-400">{metrics.upcomingSessions}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0a0f0d] p-5 rounded-2xl border border-[#1a2824] space-y-4 lg:col-span-2 shadow-2xl">
            <div className="flex items-center justify-between font-mono">
              <h3 className="text-sm font-semibold text-white">Recent Execution History</h3>
              <span className="text-xs text-neutral-400">Past & Rescheduled Sessions</span>
            </div>

            {recentActivity.length === 0 ? (
              <div className="p-8 text-center text-neutral-400 text-xs font-mono rounded-xl border border-dashed border-[#1a2824]">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-white">{item.taskTitle}</div>
